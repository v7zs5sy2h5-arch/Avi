...
export default function SyncSection() {
  ...
  return (
    <div className="stack">
      <p className="sync-hint">
        כדי שהנתונים שלך יהיו זהים באייפד, באייפון ובמחשב - מייצאים קוד במכשיר אחד ומייבאים אותו במכשיר השני.
        זה לא אוטומטי (צריך לחזור על זה כל פעם שרוצים לעדכן מכשיר אחר), אבל זה עובד תמיד בלי תלות באינטרנט או בשירות חיצוני.
      </p>
